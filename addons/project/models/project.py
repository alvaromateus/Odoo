...
class Task(models.Model):
    ...
    # campos adicionais
    visita = fields.Boolean('Houve visita?')
    remoto = fields.Boolean('Foi realizado acesso remoto no equipamento?')

    matriz_departamental = fields.Selection([
           #('Certificados','Certificados Digitais e Licenças'),
           ('Patrimonio','Patrimônio'),
           ('Almoxarifado','Almoxarifado'),

           ('Infraestrutura','Infraestrutura Tecnológica'),
           ('Seguranca','Segurança da Informação'),
           ('Sistemas','Sistemas'),
           ('Supervisao','Supervisão Departamental'),
           ('Suporte','Suporte Técnico'),

           ('Equipamentos','NÃO UTILIZAR - Equipamentos e Materiais'),
           ('Projetos','NÃO UTILIZAR - Projetos'),
           ('Outro','NÃO UTILIZAR - Outros'),
    ], 
    string='Matriz Departamental', required=True)
